  ...
  return (
    ...
    <div style={{ position: 'fixed', inset: 0, background: '#000', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden', background: '#000' }}>
        ...
        {/* YouTube iframe — sized to fill height, centered, cropped sides */}
        {moment && (
        ...
        {/* Block YouTube title bar at very top of iframe */}
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 52, background: 'rgba(0,0,0,0.98)', zIndex: 4, pointerEvents: 'none' }} />
        {/* Block YouTube bottom controls */}
