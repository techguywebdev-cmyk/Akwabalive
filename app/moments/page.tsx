    ...
    >
      ...
      {moment && (
        <iframe
          ...
          style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%) scale(1.8)', width: '100%', height: '56.25vw', minHeight: '100%', border: 'none', zIndex: 1, transformOrigin: 'center center' }}
