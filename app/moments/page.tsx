...
export default function MomentsPage() {
  ...
  return (
    <div
      style={{ background: '#000', height: '100svh', overflow: 'hidden', position: 'relative', userSelect: 'none' }}
    ...
    >
      ...
      {/* Gradient overlay — bottom heavy so info is readable */}
      ...
      <div style={{ position: 'absolute', right: 14, bottom: 160, zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
        <GlassBtn
