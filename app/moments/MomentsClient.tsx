...
export default function MomentsClient() {
  ...
  useEffect(() => {
    ...
    const t = window.setTimeout(() => playerRef.current?.play(), 80);
  ...
  useEffect(() => {
    function onKey(e: KeyboardEvent) {
      if (showComments || lightbox || showSearch) return;
  ...
  }, [goNext, goPrev, showComments, lightbox, showSearch]);
  ...
  function handleTouchEnd(e: React.TouchEvent) {
    ...
    /* Swipe is a user gesture — iOS will allow play (muted, or unmuted if already unlocked) */
