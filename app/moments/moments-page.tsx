  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden', background: '#000' }}>
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 60, zIndex: 5, background: 'rgba(0,0,0,0.95)', pointerEvents: 'none' }} />
        ...
        {moment && (
          <iframe key={moment.id}
            ...
            style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)', width: 'calc((100svh - 56px) * 16 / 9)', height: '100%', minWidth: '100%', border: 'none', zIndex: 2 }}
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 72, zIndex: 10, padding: '0 18px 20px' }}>
          ...
          <div style={{ display: 'flex', gap: 6, overflowX: 'auto', paddingBottom: 4, scrollbarWidth: 'none', marginBottom: 12 }}>
            {photos.map((src, i) => (
              <div key={i} style={{ width: 52, height: 52, borderRadius: 8, flexShrink: 0, backgroundImage: `url(${src})`, backgroundSize: 'cover', backgroundPosition: 'center', border: '1px solid rgba(255,255,255,0.15)', overflow: 'hidden' }} />
            ))}
            <div style={{ width: 52, height: 52, borderRadius: 8, flexShrink: 0, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 2 }}>
              <span style={{ fontFamily: 'var(--font-dm-mono,monospace)', fontSize: 8, color: C.c3 }}>MORE</span>
            </div>
          </div>
