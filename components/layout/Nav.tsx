...
export default function Nav({
  ...
  transparent?: boolean;
  active?: string;
  /** moments = hamburger left, logo center, search right, no + List */
    ...
    >
      <span
        style={{
          ...
          width: 20,
          height: 1.5,
          background: mobileOpen ? 'transparent' : 'rgba(245,236,215,0.6)',
  ...
  return (
    <>
                ...
                {LINKS.map((link) => (
                  <Link
                    ...
                    style={{
                      ...
                      textTransform: 'uppercase',
                      color:
                        active === link.label ? '#C8922A' : 'rgba(245,236,215,0.35)',
                      padding: '0 16px',
                      lineHeight: '62px',
                      display: 'block',
                      textDecoration: 'none',
                          ...
                          {[
                            ...
                            <Link
                              ...
                              style={{
                                ...
                                fontSize: 13,
                                color:
                                  item.label === 'Organizer Dashboard'
                                    ? '#C8922A'
      ...
      {/* Shared mobile drawer — identical on homepage and Moments */}
      {mobileOpen && (
        <div
          style={{
            position: 'fixed',
          ...
          {LINKS.map((link) => (
            <Link
              ...
              style={{
                ...
                textTransform: 'uppercase',
                color:
                  active === link.label ? '#C8922A' : 'rgba(245,236,215,0.55)',
                padding: '16px 0',
                borderBottom: '1px solid rgba(245,236,215,0.07)',
                textDecoration: 'none',
                display: 'block',
