  ...
  return (
    ...
    >
      <div className="relative overflow-hidden" style={{ height: 200 }}>
        ...
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, #0A0A0A 0%, transparent 100%)' }} />
      </div>
      <div className="absolute bottom-0 left-0 right-0 p-4">
        <div
          className="transition-colors duration-200 group-hover:text-[#22C55E]"
          style={{ fontFamily: 'var(--font-cormorant,serif)', fontSize: 22, fontWeight: 400, color: '#F2F2F0', letterSpacing: '-0.3px' }}
        >
          {city.name}
        </div>
